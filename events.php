      ...
      <div class="col-lg-4">
        ...
        <div class="sidebar-widget mb-4 fu">
          ...
          <div class="sw-body">
            ...
            <a class="sw-link" href="#" onclick="filterCat('research')"><i class="bi bi-flask"></i>Research <span
        ...
        <div class="sidebar-widget mt-4 fu">
          ...
          <div class="sw-body">
            <a class="sw-link" href="admissions.php"><i class="bi bi-door-open"></i>Apply for MBBS 2026-27</a>
            <a class="sw-link" href="gallery.php"><i class="bi bi-images"></i>Photo Gallery</a>
            <a class="sw-link" href="umr.php"><i class="bi bi-flask"></i>UMR Society</a>
            <a class="sw-link" href="contact.php"><i class="bi bi-envelope"></i>Contact PMC</a>
          </div>
        </div>
  ...
  <div class="container">
    <div class="recog-grid">
      ...
      <div class="recog-cell">
        ...
        <div class="recog-name">Riphah University</div>
      </div>
      <div class="recog-cell">
