              ...
              <div class="container">
                <div class="row g-4">
                  ...
                  <div class="col-lg-3">
                    ...
                    <a class="mega-link" href="https://dms.riphahpsh.edu.pk/" target="_blank"><i class="bi bi-hospital"></i>Department of Medical
                      Sciences</a>
                    <a class="mega-link" href="https://riphahpsh.edu.pk/dicr" target="_blank"><i class="bi bi-heart-pulse"></i>Department of
                      Islamiyat & Comparative Religion</a>
                  </div>
                  <!-- <div class="col-lg-3">
              ...
              <div class="container">
                <div class="row g-4">
                  ...
                  <div class="col-lg-4">
                    ...
                    <a class="mega-link" href="https://pdc.prime.edu.pk/downloads/Admission_Policy_Session_2023-24.pdf"><i class="bi bi-check-circle"></i>
                      Admissions Policy (Undergraduate)</a>
                      <a class="mega-link" href="https://pdc.prime.edu.pk/downloads/pgmi-admission-policy-pg.pdf"><i class="bi bi-list-ol"></i>
                      Admissions Policy (Postgraduate)</a>
              ...
              <div class="container">
                <div class="row g-4">
                  ...
                  <div class="col-lg-4">
                    ...
                    <a class="mega-link" href="https://riphahpsh.edu.pk/pubedu.php"><i
