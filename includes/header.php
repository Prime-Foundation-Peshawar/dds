        ...
        <ul class="navbar-nav ms-auto align-items-lg-center position-static">
          ...
          <li class="nav-item mega-menu-wrapper">
            ...
            <div class="dropdown-menu plain-dd" style="min-width:260px;">
              ...
              <a class="dropdown-item" href="pg-coming-soon.php"><i class="bi bi-hourglass-split"></i>Postgraduate Dental Education</a>
              ...
              <div class="container">
                <div class="row g-4">
                  <div class="col-lg-4">
                    ...
                    <a class="mega-link" href="pg-coming-soon.php"><i class="bi bi-journal-medical"></i>Postgraduate Dental Education</a>
