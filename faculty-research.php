 ...
 * Data source: ORIC Dental API
 */
$page_title       = 'Faculty Research — Peshawar Dental College';
$page_description = 'Explore the extensive research publications by faculty members of Peshawar Dental College, covering all dental specialties and disciplines.';
$active_nav       = 'faculty-research.php';

$debug_mode = isset($_GET['debug']) && $_GET['debug'] === '1';

// ── Fetch publication data from ORIC DENTAL API ─────────────────
$api_url = 'https://oric.riphahpsh.edu.pk/apis/getPublicationsInfoDental.php';
...
<section class="pmc-section">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="sec-title" style="font-size:1.8rem;">Research Publications</h2>
        <p class="mb-4">
          The faculty of <strong>Peshawar Dental College</strong> have an outstanding record of research contributions. Below is the complete list of publications, dynamically sourced from the ORIC research database.
        </p>
            ...
            <div class="col-md-4">
              ...
              <select id="deptFilter" class="form-select">
                ...
                <?php foreach ($departments as $dept): 
                  if(!empty($dept)):?>
                  <option value="<?= trim(htmlspecialchars($dept)) ?>"><?= htmlspecialchars($dept) ?></option>
