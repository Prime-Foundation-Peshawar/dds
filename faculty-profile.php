...
$page_title = ($display_name !== '' ? $display_name . ' — Faculty' : 'Faculty') . ' | Department of Dental Sciences';
$page_description = $display_name !== ''
  ? $display_name . ' teaches at Peshawar Dental College, Riphah Peshawar Campus.'
  : 'Faculty at the Department of Dental Sciences, Peshawar Dental College.';
...
<link href="<?= dds_asset('assets/css/faculty.css') ?>" rel="stylesheet"/>
    ...
    <article id="fpCard" class="fp-layout"<?= $extra ? '' : ' hidden' ?>>
      <aside class="fp-side">
        ...
        <div class="fp-side-meta">
          <p class="fp-kicker">Department of Dental Sciences</p>
          <p class="fp-dept" id="fpDept"><?= htmlspecialchars($dept !== '' ? $dept : 'Peshawar Dental College') ?></p>
...
(async function init() {
  ...
  if (hrms) {
    ...
    document.title = name + ' — Faculty | Department of Dental Sciences';
