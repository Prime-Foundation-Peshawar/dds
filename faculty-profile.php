...
.profile-dept-link:hover { background: rgba(194,65,12,.25); }
.profile-name {
...
.pc-btn:hover { background: rgba(194,65,12,.35); border-color: var(--teal-light); color: white; }
    ...
    <div class="row g-5">
      ...
      <div class="col-lg-8">
        ...
        <div class="tab-pane active fu" id="tab-bio">
          ...
          <div class="pmc-card mt-4" style="border-radius:12px;background:var(--teal-pale);border-color:rgba(194,65,12,.2);">
